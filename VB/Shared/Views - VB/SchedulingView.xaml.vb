...
Namespace DXSample.Views
	Partial Public Class SchedulingView
		...
		Public Sub New()
			...
			AddHandler scheduler.AppointmentAdded, Function(d, e) e.Appointments.ForEach(Sub(x) LogChange(x, "added"))
			AddHandler scheduler.AppointmentEdited, Function(d, e) e.Appointments.ForEach(Sub(x) LogChange(x, "edited"))
			AddHandler scheduler.AppointmentRemoved, Function(d, e) e.Appointments.ForEach(Sub(x) LogChange(x, "removed"))
			AddHandler scheduler.AppointmentRestored, Function(d, e) e.Appointments.ForEach(Sub(x) LogChange(x, "restored"))
